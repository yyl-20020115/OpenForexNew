...
namespace Arbiter.MessageContainerTransport.GZipEncoder
{
    ...
    internal class GZipMessageEncoderFactory : MessageEncoderFactory
    {
        ...
        class GZipMessageEncoder : MessageEncoder
        {
            ...
            //Helper baseMethod to compress an array of bytes
            ...
            //Helper baseMethod to decompress an array of bytes
            ...
            public override void WriteMessage(System.ServiceModel.Channels.Message message, System.IO.Stream stream)
            {
                ...
                // innerEncoder.WriteMessage(requestMessage, gzStream) depends on that it can flush data by flushing 
