// This is a *modified* version of the Yedda
// http://blogs.msdn.com/shitals/archive/2008/12/27/9254245.aspx#9852546
// ----
...
{
    /// <summary>
    /// Class handles communication with the Twitter API interface.
    /// </summary>
    public class Twitter
    {
        ...
        protected string ExecutePostCommand(string url, string userName, string password, string data)
        {
            ...
            // Modifications to Yedda, as suggested here:
            // http://blogs.msdn.com/shitals/archive/2008/12/27/9254245.aspx#9852546
