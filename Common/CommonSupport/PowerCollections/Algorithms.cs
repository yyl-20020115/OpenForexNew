...
{
    /// <summary>
    /// The BinaryPredicate delegate type  encapsulates a baseMethod that takes two
    ...
    public static class Algorithms
    {
        ...
        /// </summary>
        /// <remarks>This baseMethod can be used to apply an algorithm to a portion of a list. For example:
        ...
        /// </summary>
        /// <remarks>This baseMethod can be used to apply an algorithm to a portion of a array. For example:
        ...
        /// <summary>
        /// The read-only ICollection&lt;T&gt; implementation that is used by the ReadOnly baseMethod.
        ...
        /// <summary>
        /// The read-only IList&lt;T&gt; implementation that is used by the ReadOnly baseMethod.
        ...
        /// are of type <paramref name="T"/> or a type derived from it. This baseMethod is useful
        ...
        /// this baseMethod will first attempt to cast <paramref name="untypedCollection"/> to IEnumerable&lt;T&gt;. 
        ...
        /// this baseMethod will first attempt to cast <paramref name="untypedCollection"/> to ICollection&lt;T&gt;. 
        ...
        /// </summary>
        /// <remarks>Some collections implement both generic and non-generic interfaces. For efficiency,
        /// this baseMethod will first attempt to cast <paramref name="untypedList"/> to IList&lt;T&gt;. 
        /// If that succeeds, it is returned; otherwise, a wrapper object is created.</remarks>
        ...
        /// This baseMethod is useful when interfacing generic interfaces with older code that uses non-generic interfaces.
        /// </summary>
        /// <remarks>Many generic collections already implement the non-generic interfaces directly. This
        /// baseMethod will first attempt to simply cast <paramref name="typedCollection"/> to ICollection. If that
        ...
        /// </summary>
        /// <remarks>Many generic collections already implement the non-generic interfaces directly. This
        /// baseMethod will first attempt to simply cast <paramref name="typedList"/> to IList. If that
        /// succeeds, it is returned; if it fails, then a wrapper object is created.</remarks>
        ...
        /// be made through the interface. This baseMethod creates a read-write IList&lt;T&gt; wrapper
        /// on an array that can be used to make changes to the array. </para>
        /// <para>Use this baseMethod when you need to pass an array to an algorithms that takes an 
        /// IList&lt;T&gt; and that tries to modify items in the list. Algorithms in this class generally do not
        /// need this baseMethod, since they have been design to operate on arrays even when they
        ...
        /// <param name="itemFind">The value to find and replace within <paramref name="collection"/>.</param>
        /// <param name="replaceWith">The new value to replace with.</param>
        /// <param name="equalityComparer">The IEqualityComparer&lt;T&gt; used to compare items for equality. Only the Equals baseMethod will be called.</param>
        /// <returns>An new collection with the items from <paramref name="collection"/>, in the same order, 
        /// with the appropriate replacements made.</returns>
        ...
        /// <para>Although arrays cast to IList&lt;T&gt; are normally read-only, this baseMethod
        ...
        /// </summary>
        /// <remarks>Although arrays cast to IList&lt;T&gt; are normally read-only, this baseMethod
        ...
        /// would be matched by the predicate, then this baseMethod is inappropriate, because
        ...
        /// <param name="collection">The collection to search.</param>
        /// <param name="predicate">A delegate that defined the condition to check for.</param>
        /// <param name="foundItem">Outputs the first item in the collection that matches the condition, if the baseMethod returns true.</param>
        ...
        /// <param name="collection">The collection to search.</param>
        /// <param name="predicate">A delegate that defined the condition to check for.</param>
        /// <param name="foundItem">Outputs the last item in the collection that matches the condition, if the baseMethod returns true.</param>
        /// <returns>True if an item satisfying the condition was found. False if no such item exists in the collection.</returns>
        ...
        /// collections, it is more efficient to use the IsSubsetOf baseMethod on that class.</para>
        /// </remarks>
        ...
        /// implementation of IComparable&lt;T&gt;.Equals or object.Equals.</para>
        /// <para>If both collections are Set, Bag, OrderedSet, or OrderedBag
        /// collections, it is more efficient to use the IsDisjoint baseMethod on that class.</para>
        /// </remarks>
        /// <param name="collection1">The first collection.</param>
        /// <param name="collection2">The second collection.</param>
        ...
        /// implementation of IComparable&lt;T&gt;.Equals or object.Equals.</para>
        /// <para>If both collections are Set, Bag, OrderedSet, or OrderedBag
        /// collections, it is more efficient to use the EqualTo baseMethod on that class.</para>
        /// </remarks>
        /// <param name="collection1">The first collection.</param>
        /// <param name="collection2">The second collection.</param>
        ...
        /// converted to a string by calling its ToString baseMethod (null is represented by "null").
        /// Contained collections (except strings) are recursively converted to strings by this baseMethod.
        /// </summary>
        ...
        /// </summary>
        /// <param name="collection">A collection to get the string representation of.</param>
        /// <param name="recursive">If true, contained collections (except strings) are converted to strings by a recursive call to this baseMethod, instead
        ...
        /// </summary>
        /// <remarks>If the collection implements IList&lt;T&gt;, then this baseMethod takes time O(<paramref name="count"/>).
        /// Otherwise, this baseMethod takes time O(N), where N is the number of items in the collection.</remarks>
        /// <typeparam name="T">The type of items in the collection.</typeparam>
        ...
        /// has N items, then N factorial permutations will be generated. This baseMethod does not compare the items to determine if
        /// any of them are equal. If some items are equal, the same permutation may be generated more than once. For example,
        /// if the collections contains the three items A, A, and B, then this baseMethod will generate the six permutations, AAB, AAB,
        ...
        /// if the collections contains the three items A, A, and B, then this baseMethod will generate only the three permutations, AAB, ABA,
        /// BAA. 
        /// </summary>
        /// <typeparam name="T">The type of items to permute.</typeparam>
        /// <param name="collection">The collection of items to permute.</param>
        ...
        /// the Compare baseMethod is used.</param>
        /// <returns>An array containing the sorted version of the collection.</returns>
        ...
        /// <summary>
        /// A private class used by the LexicographicalComparer baseMethod to compare sequences
        ...
        /// <param name="converter">A delegate to the baseMethod to call, passing each item in <paramref name="sourceCollection"/>.</param>
        ...
        /// <returns>A delegate to a baseMethod that converts keys to values. </returns>
        ...
        /// </summary>
        /// <remarks>If the collection implements ICollection&lt;T&gt;, this baseMethod
