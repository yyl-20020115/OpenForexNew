...
namespace CommonSupport
{
    ...
    public class BigList<T>: ListBase<T>, ICloneable
    {
        ...
        /// </summary>
        /// <remarks>This baseMethod takes time O(M + log N), where M is the number of items in the 
        ...
        /// a value type, then this baseMethod is the same as Clone.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>This baseMethod takes, on average, constant time, regardless of the size
        ...
        /// </summary>
        /// <remarks>This baseMethod takes take O(log N), where N is the size of the current list. Although
        ...
        /// more efficient <see cref="Range"/> baseMethod, which provides a view onto a sub-range of items.</remarks>
        ...
        /// </summary>
        /// <remarks>
        /// <para>If a copy of the sub-range is desired, use the <see cref="GetRange"/> baseMethod instead.</para>
        /// <para>This baseMethod can be used to apply an algorithm to a portion of a list. For example:</para>
        ...
        /// foreach statement is used to call this baseMethod implicitly.
        /// </summary>
        /// <remarks>Enumerating all of the items in the list take time O(N), where
