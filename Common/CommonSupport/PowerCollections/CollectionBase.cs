...
namespace CommonSupport
{
    ...
    public abstract class CollectionBase<T> : ICollection<T>, ICollection
    {
        ...
        /// </summary>
        /// <remarks><p>This baseMethod is not abstract, although derived classes should always
        ...
        /// that the baseMethod must be overridden or re-implemented in the derived class.</exception>
        ...
        /// Object.Equals.
        /// </summary>
        /// <remarks>You should strongly consider overriding this baseMethod to provide
        ...
        /// a view of the collection that prevents modifications to the collection. Use the baseMethod to provide
        ...
        /// <param name="converter">A delegate to the baseMethod to call, passing each item in this collection.</param>
