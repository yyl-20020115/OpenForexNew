...
namespace CommonSupport
{
    ...
    public class Deque<T> : ListBase<T>, ICloneable
    {
        ...
        /// <summary>
        /// Increase the amount of buffer space. When calling this baseMethod, the Deque
        ...
        /// in the Deque are increased by 1. This baseMethod is 
        ...
        /// </summary>
        /// <remarks>This baseMethod takes time O(M), where M is the number of items in the 
        ...
        /// in the Deque are unchanged. This baseMethod is 
        ...
        /// in the Deque are decreased by 1. This baseMethod is 
