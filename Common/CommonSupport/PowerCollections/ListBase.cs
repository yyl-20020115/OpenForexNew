...
namespace CommonSupport
{
    ...
    public abstract class ListBase<T> : CollectionBase<T>, IList<T>, IList
    {
        ...
        /// <summary>
        /// This baseMethod must be overridden by the derived class to empty the list
        /// of all items.
        /// </summary>
        ...
        /// <summary>
        /// This baseMethod must be overridden by the derived class to insert a new
        ...
        /// <summary>
        /// This baseMethod must be overridden by the derived class to remove the
        /// item at the given index. 
        /// </summary>
        ...
        /// exceptions. Consider overriding this baseMethod and adding checks
        ...
        /// Equals baseMethod of that interface is used to determine equality. Otherwise, 
        ...
        /// <summary>
        /// Adds an item to the end of the list. This baseMethod is equivalent to calling: 
        ...
        /// a view of the list that prevents modifications to the list. Use the baseMethod to provide
