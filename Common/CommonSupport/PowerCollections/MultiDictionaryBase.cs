...
namespace CommonSupport
{
                                                                                               ...
                                                                                               IDictionary<TKey, ICollection<TValue>>
    {
        ...
        /// <summary>
        /// Clears the dictionary. This baseMethod must be overridden in the derived class.
        /// </summary>
        ...
        /// <summary>
        /// Enumerate all the keys in the dictionary. This baseMethod must be overridden by a derived
        /// class.
        /// </summary>
        ...
        /// <summary>
        /// Enumerate all of the values associated with a given key. This baseMethod must be overridden
        ...
        /// baseMethod always adds new key-value pairs to the dictionary.</para>
        ...
        /// <summary>
        /// Adds a new key-value pair to the dictionary.  This baseMethod must be overridden in the derived class.
        /// </summary>
        /// <param name="key">Key to add.</param>
        ...
        /// <summary>
        /// Removes a key from the dictionary. This baseMethod must be overridden in the derived class.
        /// </summary>
        ...
        /// <summary>
        /// Removes a key-value pair from the dictionary. This baseMethod must be overridden in the derived class.
        /// </summary>
        /// <param name="key">Key to remove from the dictionary.</param>
        ...
        /// associated with that key are returned through the values parameter. This baseMethod must be
        ...
        /// It may be appropriate to override this baseMethod to 
        ...
        /// <paramref name="value"/>. The dictionary is not changed. This baseMethod must be overridden in the derived class.
        /// </summary>
        /// <param name="key">The key to search for.</param>
        ...
        private sealed class EnumerableValuesCollection : ReadOnlyCollectionBase<ICollection<TValue>>
        {
            ...
            public override bool Contains(ICollection<TValue> values)
            {
                ...
                foreach (ICollection<TValue> v in this) {
                    ...
                    // but there isn't a good choice here. We don't really expect this baseMethod to be used much.
