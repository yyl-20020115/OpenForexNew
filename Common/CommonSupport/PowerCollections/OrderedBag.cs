...
namespace CommonSupport
{
    ...
    public class OrderedBag<T> : CollectionBase<T>, ICloneable
    {
        ...
        /// or IComparable. 
        /// The CompareTo baseMethod of this interface will be used to compare items in this bag.
        /// </summary>
        ///<remarks>
        ...
        /// <summary>
        /// Creates a new OrderedBag. The Compare baseMethod of the passed comparison object
        ...
        /// Creates a new OrderedBag. The T must implement IComparable&lt;T&gt;
        /// or IComparable. 
        /// The CompareTo baseMethod of this interface will be used to compare items in this bag. The bag is
        ...
        /// <exception cref="InvalidOperationException">If otherBag and this bag don't use the same baseMethod for comparing items.</exception>
        ...
        /// <exception cref="InvalidOperationException">This bag and <paramref name="otherBag"/> don't use the same baseMethod for comparing items.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="otherBag"/> is null.</exception>
