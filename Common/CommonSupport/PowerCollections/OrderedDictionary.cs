...
namespace CommonSupport
{
	...
	/// then the CompareTo baseMethod of that interface will be used to compare elements. Alternatively, a comparison
	...
	public class OrderedDictionary<TKey,TValue>: DictionaryBase<TKey,TValue>, ICloneable
	{
		...
		/// or IComparable. 
		/// The CompareTo baseMethod of this interface will be used to compare keys in this dictionary.
		/// </summary>
        ...
        /// <summary>
        /// Creates a new OrderedDictionary. The Compare baseMethod of the passed comparison object
		...
		/// </summary>
		/// <param name="comparison">A delegate to a baseMethod that will be used to compare keys.</param>
        ...
        /// or IComparable. 
        /// The CompareTo baseMethod of this interface will be used to compare keys in this dictionary.</para>
        ...
        /// <summary>
        /// <para>Creates a new OrderedDictionary. The Compare baseMethod of the passed comparison object
        ...
        /// </summary>
        /// <param name="keyComparer">An IComparer that will be used to compare keys.</param>
        /// <param name="pairComparer">A delegate to a baseMethod that will be used to compare key-value pairs.</param>
        ...
        /// </summary>
        ///<remarks>
        ///<p>Typically, this baseMethod is used in conjunction with a foreach statement. For example:
        ///<code>
        ...
        /// <para>This baseMethod takes time O(log N), where N is the number of keys in the dictionary. If a value is added, It is more efficient than
        ...
        /// baseMethod can be used to merge one dictionary into another.
        /// </summary>
		...
		/// </summary>
		/// <remarks>
		/// <p>Typically, this baseMethod is not called directly. Instead the "foreach" statement is used
		/// to enumerate the elements of the dictionary, which uses this baseMethod implicitly.</p>
