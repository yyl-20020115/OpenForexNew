...
namespace CommonSupport
{
    ...
    public class OrderedMultiDictionary<TKey, TValue> : MultiDictionaryBase<TKey, TValue>, ICloneable
    {
       ...
       #region Constructors
        ...
        /// </summary>
        /// <param name="allowDuplicateValues">Can the same value be associated with a key multiple times?</param>
        /// <param name="keyComparison">A delegate to a baseMethod that will be used to compare keys.</param>
        ...
        /// <param name="allowDuplicateValues">Can the same value be associated with a key multiple times?</param>
        /// <param name="keyComparison">A delegate to a baseMethod that will be used to compare keys.</param>
        /// <param name="valueComparison">A delegate to a baseMethod that will be used to compare values.</param>
        ...
        /// baseMethod always adds a new key-value pair to the dictionary.</para>
        ...
        /// <summary>
        /// A private helper baseMethod that returns an enumerable that
        ...
        /// <summary>
        /// A private helper baseMethod for the indexer to return an enumerable that
        /// enumerates all the values for a key. This is separate baseMethod because indexers
