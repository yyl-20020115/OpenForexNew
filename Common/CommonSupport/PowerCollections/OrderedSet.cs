...
namespace CommonSupport
{
    ...
    /// then the CompareTo baseMethod of that interface will be used to compare items. Alternatively, a comparison
    ...
    public class OrderedSet<T> : CollectionBase<T>, ICollection<T>, ICloneable
    {
        ...
        /// or IComparable. 
        /// The CompareTo baseMethod of this interface will be used to compare items in this set.
        /// </summary>
        ///<remarks>
        ...
        /// </summary>
        /// <param name="comparison">A delegate to a baseMethod that will be used to compare items.</param>
        ...
        /// <summary>
        /// Creates a new OrderedSet. The Compare baseMethod of the passed comparison object
        ...
        /// Creates a new OrderedSet. The T must implement IComparable&lt;T&gt;
        /// or IComparable. 
        /// The CompareTo baseMethod of this interface will be used to compare items in this set. The set is
        ...
        /// to enumerate the items, which uses this baseMethod implicitly.</p>
        ...
        /// <exception cref="InvalidOperationException">If otherSet and this set don't use the same baseMethod for comparing items.</exception>
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same baseMethod for comparing items.</exception>
