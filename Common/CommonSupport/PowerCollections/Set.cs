...
namespace CommonSupport
{
    ...
    /// then the Equals baseMethod of that interface will be used to compare items, otherwise the Equals
    /// baseMethod from Object will be used. Alternatively, an instance of IComparer&lt;T&gt; can be passed
    ...
    public class Set<T> : CollectionBase<T>, ICollection<T>, ICloneable
    {
        ...
        /// <summary>
        /// Creates a new Set. The Equals baseMethod and GetHashCode baseMethod on T
        ...
        /// <summary>
        /// Creates a new Set. The Equals and GetHashCode baseMethod of the passed comparer object
