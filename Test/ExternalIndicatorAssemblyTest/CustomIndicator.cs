...
namespace ExternalIndicatorAssemblyTest
{
    /// <summary>
    /// This indicator demonstrates a simple implementation of a custom indicator.
    /// It implements the Zig Zag indicator model.
    /// </summary>
    [Serializable]
    public class TestCustomIndicator : CustomPlatformIndicator
    {
        /// <summary>
        ...
        /// Constructor.
        /// </summary>
        public TestCustomIndicator()
            : base("My Custom External Indicator", false, true, new string[] { "ZigZag" })
        {
        }
        ...
        {
            TestCustomIndicator result = new TestCustomIndicator();
